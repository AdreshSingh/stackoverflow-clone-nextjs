...
export const QuestionDetail = ({ questionId }: any) => {
  ...
  // const { user } = { user: { _id: "123", name: "Test User" } };// for testing
  ...
  const {user} = useAuth();
    ...
    if (!question) {
      return (
        <div className="mt-4 text-center text-gray-500">No question found.</div>
      );
    }
      ...
      <Card className="mb-8">
        <CardContent className="p-0">
          <div className="flex flex-col sm:flex-row">
            {/* Voting Section */}
            <div className="flex items-center p-4 border-b border-gray-200 sm:flex-col sm:items-center sm:p-6 sm:border-b-0 sm:border-r">
              <Button
                variant="ghost"
                size="sm"
              ...
              <div className="flex gap-2 mt-4 sm:flex-col sm:gap-4 sm:mt-6">
                <Button
                  variant="ghost"
                  size="sm"
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {question?.questiontags?.map((tag: any) => (
                  <Link key={tag} href={`/tags/${tag}`}>
                    <Badge
                      variant="secondary"
                      className="text-blue-800 bg-blue-100 cursor-pointer hover:bg-blue-200"
                    >
                      {tag}
                    </Badge>
                  </Link>
                ...
                <div className="flex gap-2">
                  <div className="flex items-center gap-2 text-sm">
                    <span className="text-gray-600">
                      asked {new Date(question?.askedon ?? Date.now()).toLocaleDateString()}
                    </span>
                    <Link
      ...
      <Card>
        <CardContent className="p-6">
          ...
          <Textarea
            ...
            className="mb-4 resize-none min-h-32"
          />
